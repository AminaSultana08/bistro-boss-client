/**
 * 1.install stripes and stripes react 
 ...
 * 5.create payment intent post on the server and return client secret, install stripe on the server side and get client secret,, make sure u used the payment method types: ['card']
